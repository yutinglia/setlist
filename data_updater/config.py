...
UPDATE_STEADY_RETRY_BASE = _env_int(
    "UPDATE_STEADY_RETRY_BASE", 15 * 60, minimum=60
)
...
UPDATE_ANALYSIS_RETRY_BASE = _env_int(
    "UPDATE_ANALYSIS_RETRY_BASE", 30 * 60, minimum=60
)
