...
export function BrandLogo({
  ...
  return (
    <Link
      to="/"
      className={cn(
        "group inline-flex min-h-11 min-w-0 items-center gap-2.5 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        className,
      )}
